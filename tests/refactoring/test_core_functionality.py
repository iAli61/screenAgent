...
def test_core_functionality():
    ...
    try:
        ...
        # Mock dependencies
        with patch('src.core.storage.screenshot_manager.ScreenshotCapture') as MockCapture, \
             patch('src.core.storage.screenshot_manager.ROIMonitor') as MockROI, \
             patch('src.core.storage.screenshot_manager.KeyboardHandler') as MockKeyboard:
